...
contract ERC1155 is  ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function setMintApproved(address to, bool approved) external{
        require(msg.sender == owner, "ERC1155: You are not owner");

        mintApproved[to] = approved;
    }

    function mint(address to, uint256 _tokenId, uint256 amount) external {
        require(msg.sender == owner || mintApproved[msg.sender], "ERC1155: You are not owner");
    ...
    function safeTransferFrom(
        ...
        require(to != address(0x0), "ERC1155: The recipient's address must be non-zero.");
