    ...
    def draw(self, screen: "SURFACE"):
        ...
        if self.text != "" or self.placeholder != "":
            ...
            for index, line in enumerate(lines):
                if self.text == "":
                    render_line = self.font.render(line, True, (190, 190, 190))
                else:
                    render_line = self.font.render(line, True, (0, 0, 0))
        ...
        for event in events:
            ...
            if event.type == pygame.KEYDOWN and self.pressed:
                if event.key == pygame.K_BACKSPACE:
                    ...
                    a = pygame.scrap.get("text/plain;charset=utf-8")
                    self.text += a.decode("utf-16").replace("\0", "") if os.name == 'nt' else a.decode("utf-8")
                    # https://github.com/pygame/pygame/issues/3790
